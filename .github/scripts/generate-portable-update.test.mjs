...
test("generates a signed Windows portable updater manifest", () => {
  const manifest = generatePortableUpdate({
    ...
    assetName: "cursorok-1.2.3-beta.1-windows-amd64.zip",
  ...
  assert.equal(
    ...
    "https://github.com/owner/repository/releases/download/v1.2.3-beta.1/cursorok-1.2.3-beta.1-windows-amd64.zip",
  );
});
